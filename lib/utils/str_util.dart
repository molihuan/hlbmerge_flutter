...
class StrUtil {
  ...
  static String? handleSpecialCharacters(String? str) {
    ...
    final result = runPlatform<String?>(
      orElse: () {
        return sanitizeAndroidFileName(str);
      },
      onWindows: () {
        return sanitizeWindowsFileName(str);
      },
      onLinux: () {
        return sanitizeLinuxFileName(str);
      },
    );
    return result;
  }
  ...
  static String? sanitizeAndroidFileName(
